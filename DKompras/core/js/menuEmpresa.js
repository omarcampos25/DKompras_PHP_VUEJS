...
new Vue({
  ...
  data: () => ({
    titulo: "",
    drawer: null,
    ctr: "http://localhost/Dkompras/core/php/login.php",
    OpcionProductos:"0",
    admins: [
      ['Nuevo producto','1','http://localhost/Dkompras/vista/productos/Alta_productos.php','CatalogoEmpleados'],
      ['Lista de productos','1','http://localhost/Dkompras/vista/productos/Catalogo_productos.php','pro'],
      ['Familias','1','http://localhost/Dkompras/vista/productos/ModuloFamilias.php','familia'],
    ],
    cruds: [
      ['Ajustes'],
      ['Existencias'],
    ...
    configuraciones:[
      ['Usuarios','1','http://localhost/Dkompras/vista/Configuraciones/Usuarios.php','user']
